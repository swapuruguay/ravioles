...
<div class="container">
    <form class="form-inline" id="form">
            ...
            <input type="hidden" name="nro_lista" id="nro_lista" value="<?php echo $nro ?>">
        </form>
        <br>
    ...
    <div class="col-md-5">
     ...
     <script>
       ...
       form.addEventListener('submit', evt => {
         ...
         function pagarTodos() {
           let lista = document.getElementById('nro_lista').value
           let estado = 0
           ...
           //$("#resultado").html('<p><img src="img/ajax.gif" /></p>');
              $.ajax({
                      type:'POST',
                      data: datos,
                      url: 'http://'+window.location.host+'/ajax/listas.php',
                      success: res => {
                        console.log(res)
                        listar()
